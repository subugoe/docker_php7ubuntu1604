...
RUN cd /root && wget http://www.imagemagick.org/download/ImageMagick.tar.gz && tar xf ImageMagick.tar.gz
...
RUN cd /root/ImageMagick-7.0.3-7 && ./configure --prefix=/usr --with-jp2 && make && make install
